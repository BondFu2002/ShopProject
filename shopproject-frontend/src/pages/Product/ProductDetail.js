...
const ProductDetail = () => {
  ...
  // 如果商品信息尚未加载，显示加载状态
  if (!product) {
    return <div><LoadingOutlined />Loading...</div>; // 显示加载图标
  }

  return (
    <div className="product-detail-container"> {/* 商品详情容器 */}
      <h1 className="page-title">商品详情</h1> {/* 页面标题 */}
      <Descriptions
